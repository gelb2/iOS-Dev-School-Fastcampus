...
jun.name = @ "junyoungjee";
    ...
    // jun.name = @ "junyoungjee"; / kim.name = @ "kimjiyoung"; 은 각각 준, 김 이라는 객체의 프로퍼티인 name이 junyoungjee, kimjiyoung 이라는 의미임
...
http://goo.gl/idJNx7 
https://goo.gl/ENEuFd https://goo.gl/N93iuO
