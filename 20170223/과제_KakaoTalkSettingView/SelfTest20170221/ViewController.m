...
- (void)viewDidLoad {
    ...
    self.textArraySection1 = [[NSArray alloc] initWithObjects:@"개인 및 보안", @"알림 및 친구",@"채팅", @"화면",@"게임",@"기타", nil];
...
////UX상 필요없는 메소드 이므로 주석 처리함 네비게이션바의 뷰컨트롤러 이동용 메소드
//-(void)gotoFront:(UIButton *)sender{
//    
